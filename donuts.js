(function(Raphael) {
  Raphael.donutGraph = function(target, size, num, total, outerColor, innerColor) {
    return new DonutGraph(target, size, num, total, outerColor, innerColor);
  };
  function DonutGraph(target, size, num, total, outerColor, innerColor) {
